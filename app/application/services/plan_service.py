...
class PlanService:
    ...
    def update_plan(self, plan_id: UUID, plan_data: PlanUpdate) -> PlanResponse:
    ...
    def delete_plan(self, plan_id: UUID) -> dict:
        """Elimina un plan."""
    ...
    def deactivate_plan(self, plan_id: UUID) -> PlanResponse:
        """Desactiva un plan."""
