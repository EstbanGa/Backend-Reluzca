...
from app.infrastructure.repositories.calificacion_repository import CalificacionRepository
from app.application.services.calificacion_service import CalificacionService
